...
#define SECONDARY_EXEC_ENABLE_VM_FUNCTIONS	0x00002000    //vm function secondary processor-based  enable vm function
...
enum vmcs_field {
	...
	VM_FUNCTION_CTRL_HIGH           = 0x00002019,//添加VM-FUNC Controls 域，B.2.1 Table B-4
	...
	EPTP_LIST_ADDRESS_HIGH          = 0x00002025,//添加EPTP list addr 域
